...
func main() {
	...
	streamService := service.NewStreamService(channelService, categoryService, streamRepo, appConfig.Server.SrtServerUrl, appConfig.Server.HlsServerUrl, appConfig.Server.RecordServerUrl, chatClient, txManager, logger, minioClient)
